...
const SREVIEW: StaticReviewProps = { width: 1080, height: 1350, brand: SBRAND, reviewerName: "Tamara L.", rating: 5, quote: "Lost weight and the flavor is great. I couldn't start my morning without it.", verified: true, productTitle: "Amazing Coffee", productImageUrl: null };
