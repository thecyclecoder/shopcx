...
-- swallowed — zero notifications, nothing reached the CEO inbox. Add the three agent inbox types
-- (AGENT_INBOX_TYPES in src/lib/agents/inbox.ts) to the CHECK. Idempotent (drop + re-add).
