...
-- swallowed — zero notifications reached the CEO inbox (and the box's escalation backstop re-emitted into
-- the same rejection). Add the three agent inbox types (AGENT_INBOX_TYPES in src/lib/agents/inbox.ts) to
-- the CHECK. Idempotent (drop + re-add). Applied to prod 2026-06-24.
