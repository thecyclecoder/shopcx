...
- Reads [[../tables/worker_heartbeats]] (box), [[../tables/loop_heartbeats]] (crons + agent kinds + inline agents), [[../tables/loop_alerts]] (open incidents), [[../tables/agent_jobs]] (stuck detection + Phase 2 enqueue checks), plus [[../tables/tickets]] + [[../tables/subscriptions]] for the Phase 2 output assertions and [[../tables/tickets]] + [[../tables/journey_sessions]] + [[../tables/orders]] for the inline-agent work-exists probes.
