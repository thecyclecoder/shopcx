...
- **Reading playbook:** [[../recipes/growth-funnel-reading]] — how the Director interprets the funnel-tree ("what") + chapter-diagnostics ("why") SDKs and what to act on (carry-to-pricing vs close levers, CTA-origin, the U-shaped depth). The runtime decision-guidance for this mandate; bakes into [[../libraries/growth-director]].
