...
**Follow-up (split out):** the retroactive reconcile/backfill of already-swallowed escalations is now [[director-escalations-must-surface-to-ceo-backfill-swallowed]] — built at/before Platform activation (live+autonomous); not needed to make this forward-fix useful today.
