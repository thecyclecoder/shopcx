...
- ✅ **Portal: "Resources" sidebar** — **verified + archived 2026-06-18** ([[../archive]]): 36 blog articles imported → `posts` (35 product resources), images migrated off Shopify, AI-classified (product + grouping), portal Resources UI live (search + product→grouping + reader) **and** the public storefront blog. Import ran as a 36-agent workflow. Folded → [[../lifecycles/storefront-blog]] (+ [[../tables/posts]], [[../tables/post_products]], [[../lifecycles/customer-portal]] § Resources, [[../dashboard/storefront__blog]]). Remaining = future only (RAG embedding for AI citations, periodic re-sync).
