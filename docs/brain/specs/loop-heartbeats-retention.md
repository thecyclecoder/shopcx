...
A daily batched prune (`ran_at < now() - 24h`) registered as a monitored loop; verify/​fix the RPC's distinct-loop source. (The one-time 21M-row backlog prune is run with owner authorization alongside.) Brain: [[../libraries/control-tower]] · [[control-tower]] · [[control-tower-loop-beats-rpc-perf]] · [[../tables/loop_heartbeats]].
