...
## Phase 1 — the `plan` intent + directive store + critical marker ✅ (board pip ⏳)
...
## Phase 3 — surfacing + "Ada knows" ✅ (hub pip ⏳)
- The active directive headlines the standing pass + the daily board-watch note ("🎯 active directive: X · builds GATED until Y ships"). ⏳ remaining: a dedicated directive card on the [[../dashboard/agents|Agents hub]] / her profile (the standing-pass note + the chat already surface it).
