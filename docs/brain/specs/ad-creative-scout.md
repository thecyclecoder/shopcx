...
- ✅ **Migration applied** — `20260702120000_creative_skeletons_full_payload.sql` applied to prod via `scripts/apply-creative-skeletons-full-payload-migration.ts` (owner-approved).
