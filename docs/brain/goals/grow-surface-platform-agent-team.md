...
### M1 — Roster sync
- **Agent roster sync** ✅ — shipped & archived ([[../dashboard/agents]] · [[../archive]]) — reconcile MONITORED_LOOPS (cron + agent-kind) ↔ PERSONAS ↔ live agent_jobs into one roster so the org view surfaces 100% of running agents (incl. Tao/Devi/Cole + control-tower-monitor) and flags inactive ones (Remi).
