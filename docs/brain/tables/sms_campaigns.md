...
| `recipients_delivered` | `int4` | — | default: `0` — running count of terminal-delivered recipients. Recounted by [[../inngest/sms-callback-drain]] every drain batch (not increment — idempotent across re-delivered callbacks). |
