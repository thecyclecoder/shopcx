...
| `action_kind` | `text` | what was done — **open vocabulary, no CHECK** (new kinds land without a migration). regression-agent emits: `detected_regression｜dismissed_regression｜authored_fix｜escalated`; the [[../libraries/worker-coaching|coaching pass]] emits: `coached_worker｜coaching_routed_to_repair｜escalated_coaching` |
...
[[../libraries/director-activity]] · [[../specs/regression-agent]] · [[../goals/devops-director]] · [[../specs/director-loop-grading]] · [[../specs/worker-coaching-loop]] · [[../libraries/worker-coaching]] · [[director_messages]] · [[../libraries/director-board]]
