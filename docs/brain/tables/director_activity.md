...
| `action_kind` | `text` | what was done — **open vocabulary, no CHECK** (new kinds land without a migration). regression-agent emits: `detected_regression｜dismissed_regression｜authored_fix｜escalated` |
...
[[../libraries/director-activity]] · [[../specs/regression-agent]] · [[../goals/devops-director]] · [[../specs/director-loop-grading]] · [[director_messages]] · [[../libraries/director-board]]
