...
## Status / open work
- **Shipped:** [[../specs/experiment-session-stamped-attribution]] (Phases 1–4) — session arm stamp, first-class `orders.session_id`, session-stamped attribution + funnel, and the order-detail Journey panel. ✅
