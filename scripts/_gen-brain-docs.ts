...
const SUMMARIES: Record<string, string> = {
  ...
  product_intelligence: "AI-generated product intelligence (positioning, competitor analysis, recommended angles).",
...
const grouped: Record<string, string[]> = {
  ...
  "Product catalog": ["products", "product_variants", "product_media", "product_ingredients", "product_ingredient_research", "product_how_it_works", "product_benefit_angles", "product_benefit_selections", "product_intelligence", "product_link_groups", "product_link_members", "product_page_content", "product_pricing_rule", "product_pricing_tiers", "product_seo_keywords"],
