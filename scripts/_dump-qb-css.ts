...
async function main() {
  ...
  const content = await readThemeFile(live.target, "assets/quantity-breaks.css");
  if (!content) { console.error("NOT FOUND"); process.exit(1); }
  const out = "/private/tmp/claude-501/-Users-admin-Projects-shopcx/157c5e1d-b40b-4bb8-838d-10303624a6a8/scratchpad/quantity-breaks.css";
