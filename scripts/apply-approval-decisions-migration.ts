// apply-approval-decisions-migration — create public.approval_decisions (approval-routing-engine
// Phase 3: the supervisable-autonomy ledger — one row per routed approval decision, capturing
// who decided, what, why, and whether it was autonomous). Idempotent (CREATE TABLE IF NOT EXISTS
