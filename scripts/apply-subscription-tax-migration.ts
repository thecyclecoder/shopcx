...
const migrationPath = resolve(__dirname, "../supabase/migrations/20260601170000_subscription_tax_quote.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("✓ Applied 20260601170000_subscription_tax_quote.sql");
  } finally {
    await client.end();
  }
}
