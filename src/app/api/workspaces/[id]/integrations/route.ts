...
export async function GET(
  ...
  return NextResponse.json({
    ...
    transactional_from_email: workspace.transactional_from_email,
    transactional_from_name: workspace.transactional_from_name,
    transactional_reply_to_email: workspace.transactional_reply_to_email,
    ...
    // Twilio sender phone / shortcode for marketing
...
export async function PATCH(
  ...
  try {
    ...
    if ("transactional_reply_to_email" in body) {
      updates.transactional_reply_to_email = body.transactional_reply_to_email || null;
    }
    if ("transactional_from_email" in body) {
      updates.transactional_from_email = body.transactional_from_email || null;
    }
    if ("transactional_from_name" in body) {
      updates.transactional_from_name = body.transactional_from_name || null;
    }
