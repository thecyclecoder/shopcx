...
export async function GET(
  ...
  return NextResponse.json({
    ...
    response_delays: workspace.response_delays || { email: 60, chat: 5, sms: 10, meta_dm: 10, help_center: 5, social_comments: 10, portal: 5 },
    ...
    // Twilio Verify Service SID (per-workspace OTP service) — provisioned
    // via the "Setup OTP" button in Settings → Integrations → Twilio.
    twilio_verify_service_sid: workspace.twilio_verify_service_sid || null,
