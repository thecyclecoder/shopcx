...
// Owner-only control to set a spec's PRIORITY marker (director-executable-plans-and-priority): Defer (parks it
// in the Deferred column + excludes it from every auto-build lane), Prioritize (**Priority:** critical — jumps
// the build queue), or Planned (clears both markers → a normal Planned spec). Optimistic; POSTs to
// /api/roadmap/status { slug, priority }, which commits the line-anchored marker to the brain on main.
