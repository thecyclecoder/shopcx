...
export default function CrisisDetailPage() {
  ...
  if (loading) {
    return <div className="mx-auto w-full max-w-screen-2xl px-4 py-6 sm:px-6"><p className="text-zinc-400">Loading...</p></div>;
  }

  if (!crisis) {
    return <div className="mx-auto w-full max-w-screen-2xl px-4 py-6 sm:px-6"><p className="text-zinc-400">Crisis event not found.</p></div>;
  }
