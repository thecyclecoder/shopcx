...
import { DEVELOPER_NAV, type DeveloperBadgeKey } from "@/lib/developer-nav";
        ...
        {DEVELOPER_NAV.map((item) => {
          ...
          return (
            ...
            >
              ...
              <h2 className="mt-2.5 text-sm font-semibold text-zinc-900 dark:text-zinc-100">{item.label}</h2>
