...
export default function IntegrationsPage({ filterSection }: { filterSection?: string }) {
  ...
  const show = (slug: string) => !filterSection || filterSection === slug;

  return (
    <div className={filterSection ? "px-4 sm:px-6 pb-8" : "p-4 sm:p-8 overflow-x-hidden"}>
      {!filterSection && (
        <div className="mb-6">
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          {canEdit && amplifierConnected && (
            <div className="mt-5 space-y-4">
              ...
              {/* SLA Settings moved to Settings → Tracking SLA */}
