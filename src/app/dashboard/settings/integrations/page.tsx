      ...
      .then(data => {
        setIntegrations([
          ...
          },
          {
            slug: "braintree",
            name: "Braintree",
            description: "Payment processing, vaulted cards, sub renewals",
          ...
          },
          {
            ...
            connected: !!(data.twilio_phone_number || data.twilio_verify_service_sid),
          },
          {
            slug: "avalara",
            name: "Avalara (AvaTax)",
            description: "Sales tax calculation + filing for the storefront and subscription program",
            icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
            iconBg: "bg-orange-600/10",
            connected: !!data.avalara_connected,
          },
          {
            slug: "klaviyo",
            name: "Klaviyo",
