...
export default function ChargebackSettingsPage() {
  ...
  if (loading) {
    return (
      <div className="mx-auto w-full max-w-screen-2xl px-4 py-6 sm:px-6 overflow-x-hidden">
  ...
  return (
    <div className="mx-auto w-full max-w-screen-2xl space-y-8 px-4 py-6 sm:px-6 overflow-x-hidden">
      <div>
