...
// No `runtime` pin — Next 16 cacheComponents disallows an explicit runtime; this renders on the default
// (Node/Fluid Compute) runtime, which next/og ImageResponse supports.
