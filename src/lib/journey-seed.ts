...
export const DEFAULT_REMEDIES = [
  ...
  { name: "Pause 30 Days", type: "pause", config: { pause_days: "30" }, description: "Pause subscription for 30 days", priority: 2 },
  { name: "Pause 60 Days", type: "pause", config: { pause_days: "60" }, description: "Pause subscription for 60 days", priority: 3 },
  { name: "Skip Next Order", type: "skip", config: {}, description: "Skip the next scheduled order (manual — Appstle skip disabled)", priority: 4 },
  { name: "Monthly Frequency", type: "frequency_change", config: { frequency_interval: "monthly" }, description: "Switch to monthly deliveries", priority: 5 },
  { name: "Every Other Month", type: "frequency_change", config: { frequency_interval: "bimonthly" }, description: "Switch to every-other-month deliveries", priority: 6 },
  { name: "Free Product", type: "free_product", config: {}, description: "Add a free product to your next order", priority: 7 },
  { name: "Change Items", type: "line_item_modifier", config: {}, description: "Swap flavors, adjust quantities, or try something new", priority: 8 },
];
