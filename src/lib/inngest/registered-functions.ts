...
import { storefrontLeverMemoryDecay, storefrontLeverMemoryDecayCron } from "@/lib/inngest/storefront-lever-memory";
...
export const registeredInngestFunctions = [
  ...
  storefrontLeverMemoryDecay,
  storefrontLeverMemoryDecayCron,
  amazonSyncOrders,
  amazonSyncAsins,
  amazonDailySyncCron,
