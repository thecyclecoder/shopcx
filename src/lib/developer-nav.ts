 ...
 *
 * "Developer" is no longer a collapsible section in the main tree — it's a PORTAL (the same UX as a
 * director profile): clicking it lands on the Overview (`/dashboard/developer`), and while you're
 * anywhere in these routes the sidebar swaps the main tree for this sub-nav. Add a developer surface
 * once here and it appears in BOTH the takeover and the Overview cards — no second list.
 *
...
/** The developer surfaces, in sidebar order. Excludes the Overview itself (that's the portal home). */
export const DEVELOPER_NAV: DeveloperNavItem[] = [
  {
  ...
  },
  {
    ...
    desc: "Automated spec verification (Vera)",
  },
  {
