...
export const MONITORED_LOOPS: MonitoredLoop[] = [
  ...
  { id: "storefront-experiments-refresh-cron", kind: "cron", owner: "growth", label: "Storefront experiments refresh", description: "Every-30-min fan-out: recomputes attribution + bandit posteriors for running storefront experiments (near-live test stats). No-ops when no running experiments.", expectedCadence: "every 30 min (*/30 * * * *)", livenessWindowMs: 90 * MIN, registeredAt: "2026-06-22T17:45:00Z" },
