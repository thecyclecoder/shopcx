...
export const MONITORED_LOOPS: MonitoredLoop[] = [
  ...
  { id: "agent:ticket-handle", kind: "agent-kind", owner: "cs", agentKind: "ticket-handle", label: "Agent — ticket handle", description: "First-touch direction-setting box session + inflection re-engagement.", expectedCadence: "on demand", stuckThresholdMs: 30 * MIN },
  { id: "agent:ticket-analyze", kind: "agent-kind", owner: "cs", agentKind: "ticket-analyze", label: "Agent — ticket analyze", description: "Grades every AI-handled ticket + decides reopen/escalate.", expectedCadence: "on demand", stuckThresholdMs: 30 * MIN },
  { id: "agent:prompt-review", kind: "agent-kind", owner: "cs", agentKind: "prompt-review", label: "Agent — prompt review", description: "Reviews every proposed sonnet_prompt (approve/reject).", expectedCadence: "on demand", stuckThresholdMs: 30 * MIN },
  { id: "agent:playbook-compile", kind: "agent-kind", owner: "cs", agentKind: "playbook-compile", label: "Agent — playbook compile", description: "Mines ticket history into data-grounded playbook seeds.", expectedCadence: "on demand", stuckThresholdMs: 90 * MIN },
